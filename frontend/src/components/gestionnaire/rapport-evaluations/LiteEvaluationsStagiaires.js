...
export default function LiteEvaluationsStagiaires(props) {
              ...
              <Table className="table table-striped">
                <TableHead>
                  <TableRow >
                    ...
                    <TableCell className={classes.textTitle} >Évaluateur </TableCell>
...
function AlertAucunContrat(isGestionnaire) {
  return <div className="container">
    <div className="row justify-content-md-center">
      <div className="col">
        <Alert severity="info" variant="filled" className="m-3 text-center">Aucune évaluation des stagiaires a été effectuée</Alert>
      </div>
    </div>
  </div>;
}
